document.addEventListener(`DOMContentLoaded`, function () {
  function slider_run(js_slider, js_sliderList, js_sliderTrack, js_slides, js_arrows, js_qty) {
    let slider = document.querySelector(js_slider),
      ...
      // sliderText = slider.querySelector(".js__slider-index").innerHTML,
      slides = slider.querySelectorAll(js_slides),
      arrows = slider.querySelector(js_arrows),
      prev = arrows.children[0],
      indexSlideText = arrows.children[1],
